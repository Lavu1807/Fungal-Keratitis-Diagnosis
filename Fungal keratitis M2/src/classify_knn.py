"""K-Nearest Neighbours classifier for Model M2."""
import os, json
import pandas as pd
import numpy as np
...
def main():
    ...
    results = evaluate("KNN", y_test, y_pred, y_prob)
    with open(os.path.join(RESULTS_DIR, "knn_results.json"), "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nSaved to {RESULTS_DIR}/knn_results.json")
