"""Gaussian Naive Bayes classifier for Model M2."""
import os, json
import pandas as pd
import numpy as np
...
FEATURES_PATH = os.path.join(BASE_DIR, "data", "features", "features_m2.csv")
...
def main():
    ...
    results = evaluate("GNB", y_test, y_pred, y_prob)
    with open(os.path.join(RESULTS_DIR, "gnb_results.json"), "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nSaved to {RESULTS_DIR}/gnb_results.json")
