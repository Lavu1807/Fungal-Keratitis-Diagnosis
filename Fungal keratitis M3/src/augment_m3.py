"""
Data Augmentation for Model M3 (Gaussian Convolution + Local Maximum Extraction)
=================================================================================
Augmentation Strategy:
  - Horizontal flip, Vertical flip
  - Random rotation (±20°) — conservative to preserve local maxima structures
  - Random crop (85-95% of image, resized back)
...
def main():
    ...
    print(f"Model M3 — Data Augmentation")
    print(f"{'=' * 50}")
