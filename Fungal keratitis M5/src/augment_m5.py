"""
Data Augmentation for Model M5 (Morphology + Vessel Removal)
=============================================================
Augmentation Strategy:
  - Horizontal flip, Vertical flip
  - Random rotation (±25°)
  - Random crop (85-95% of image, resized back)
  - NO Gaussian blur (morphological features would be degraded)
...
GAUSSIAN_BLUR_KERNEL = 0  # Disabled — morphological features preserved
RANDOM_SEED = 42
...
def main():
    ...
    print(f"Model M5 — Data Augmentation")
    print(f"{'=' * 50}")
