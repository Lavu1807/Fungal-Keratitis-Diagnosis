"""Logistic Regression classifier for Model M6."""
import os, json
import pandas as pd
import numpy as np
...
def main():
    ...
    results = evaluate("Logistic Regression", y_test, y_pred, y_prob)
    with open(os.path.join(RESULTS_DIR, "lr_results.json"), "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nSaved to {RESULTS_DIR}/lr_results.json")
