"""
Data Augmentation for Model M6 (Background Noise Removal + MA Extraction + NMS + Region Growing)
=================================================================================================
Augmentation Strategy:
  - Horizontal flip, Vertical flip
  - Random rotation (±15°) — conservative to preserve MA candidate structures
  - Random crop (90-95% of image, resized back) — conservative to keep MA regions
  - NO Gaussian blur (MA candidate features are delicate structures)
...
CROP_FACTOR_RANGE = (0.90, 0.95)  # Conservative to preserve MA candidates
...
def main():
    ...
    print(f"Model M6 — Data Augmentation")
    print(f"{'=' * 50}")
